      ...
      <>
        ...
        <footer>
          <div className={"container"}>
            ...
            <div className={"about"}>
              <p style={{ color: "#333" }}>
                Plano / Richardson’s state-of-the-art, family-friendly shooting
                center and event venue. Our 30,000 square foot facility offers
                pistol, rifle and archery ranges with a virtual training
                simulator and features 100-yard indoor shooting lanes! We invite
